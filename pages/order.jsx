    ...
    <div className="container px-5 py-24 mx-auto">
      <div className="lg:w-4/5 mx-auto flex flex-wrap">
        <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
          ...
          <div className="flex-grow text-center py-2 text-lg px-1">Description</div>
          <div className="flex-grow text-right border-gray-300 py-2 text-lg px-1">Quantity</div>
          <div className="flex-grow text-right border-gray-300 py-2 text-lg px-1">Sub Total</div>
        </div>
          ...
          <div className="flex border-t border-gray-200 py-2">
            <span className="text-gray-500">Wear the code (XL/Gray)</span>
            <span className="ml-auto text-gray-900">1</span>
