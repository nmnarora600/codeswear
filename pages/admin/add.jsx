...
<select value={form.category ? form.category:''} onChange={onChange} name="category" label="Category" className={`border w-[20vw]  border-gray-300 hover:border-black py-4 rounded focus:text-black ${((form.category)&&(form.category!=''))?'text-black':'text-gray-500'}`}>
...
<TextField  value={form.color ? form.color:''} onChange={onChange} name="color" className='w-[30vw]' label="Color" variant="outlined" />
            ...
            <TextField  value={form.slug ? form.slug:''} onChange={onChange} name="slug" label="slug" variant="outlined" />
          ...
          <br />
          <Button variant={hovered ? "contained" : "outlined"} onMouseEnter={() => setHovered(true)}
        onMouseLeave={() => setHovered(false)} mt={2} onClick={onSubmit}>
            Submit
          </Button>
